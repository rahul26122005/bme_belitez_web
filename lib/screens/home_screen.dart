            ...
            child: LayoutBuilder(builder: (_, c) {
              ...
              final content = Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                        color: Color(0xFFB5C8DD), fontSize: 17, height: 1.6),
                  ),
              ...
              final visual = Container(
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      width: stacked ? 220 : 310,
                      height: stacked ? 220 : 310,
                      decoration: BoxDecoration(
                    ...
                    const Positioned(
                        top: 32,
                        left: 34,
                        child: _Floating(label: 'BIO', icon: '🧬')),
                    const Positioned(
                        top: 72,
                        right: 30,
                        child: _Floating(label: 'AI', icon: '🧠')),
                    const Positioned(
                        bottom: 38,
                        left: 45,
                        child: _Floating(label: 'MED', icon: '⚕️')),
                    const Positioned(
                        bottom: 50,
                        right: 35,
                        child: _Floating(label: 'LAB', icon: '🔬')),
                  ],
                ),
              );
              ...
              if (stacked) {
                return Column(
                    children: [visual, const SizedBox(height: 45), content]);
              }
              return Row(children: [
            ...
            child: LayoutBuilder(builder: (_, c) {
              ...
              final copy = const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 7),
                  Text(
                      'Choose your events and complete your registration in a few minutes.',
