        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: LayoutBuilder(builder: (_, c) {
              ...
              final text = Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(
                        color: AppTheme.muted, fontSize: 17, height: 1.65),
                  ),
                    ...
                    return small
                        ? const Column(
                            children: [
                              ...
                              SizedBox(height: 18),
                              _MiniFeature(
                                  number: '02', title: 'Biomedical Signals'),
                              SizedBox(height: 18),
                              _MiniFeature(
                                  number: '03', title: 'Healthcare Innovation'),
                            ],
                          )
                        : const Row(
                            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: AppTheme.navy,
                        boxShadow: const [
                          BoxShadow(blurRadius: 35, color: Color(0x3316C4B8))
                        ],
                      ),
                      // child: const Icon(Icons.monitor_heart_outlined, color: Colors.white, size: 70),
                      child: Image.asset('assets/images/biomedical-crest.png',
                          fit: BoxFit.contain),
                    ),
                    const Positioned(
                        top: 34,
                        left: 34,
                        child: _OrbitCard(icon: '🔬', title: 'Research')),
                    const Positioned(
                        bottom: 32,
                        left: 28,
                        child: _OrbitCard(icon: '⚕️', title: 'Healthcare')),
                    const Positioned(
                        right: 28,
                        top: 70,
                        child: _OrbitCard(icon: '🧠', title: 'Technology')),
                  ],
                ),
              );
              ...
              if (stacked) {
                return Column(
                    children: [visual, const SizedBox(height: 45), text]);
              }
              return Row(
                  ...
                  return GridView.count(
                    ...
                    children: const [
                      _InfoCard(
                          ...
                          title: 'Research',
                          text:
                              'Evidence-driven innovation for better healthcare outcomes.'),
                      _InfoCard(
                          icon: Icons.medical_services_outlined,
                          title: 'Healthcare',
                          text:
                              'Engineering solutions designed around patients and clinicians.'),
                      _InfoCard(
                          icon: Icons.memory_outlined,
                          title: 'Technology',
                          text:
                              'Smart systems, instrumentation, imaging and rehabilitation.'),
                    ],
                  );
                }),
              ],
              ...
              return GridView.count(
                ...
                children: const [
                  _Journey(
                      number: '01',
                      title: 'LEARN',
                      text: 'Build biomedical foundations'),
                  _Journey(
                      number: '02',
                      title: 'CREATE',
                      text: 'Turn ideas into solutions'),
                  _Journey(
                      number: '03',
                      title: 'INNOVATE',
                      text: 'Design future healthcare'),
                  _Journey(
                      number: '04', title: 'CONNECT', text: 'Meet innovators'),
                ],
              );
            }),
          ),
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          shape: BoxShape.circle, color: AppTheme.navy),
                    ...
                    const Expanded(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('NEXT • B’ELITEZ 2K26',
                            style: TextStyle(
                                color: AppTheme.teal,
                                fontWeight: FontWeight.w900,
                                letterSpacing: 1.7)),
                        SizedBox(height: 6),
                        Text('Ready to enter the symposium?',
                            style: TextStyle(
                                fontSize: 28, fontWeight: FontWeight.w900)),
                        SizedBox(height: 5),
                        Text(
                            'Continue to the official symposium registration home page.',
                          ...
                          children: [
                            ...
                            FilledButton(
                              onPressed: () => Navigator.pushNamed(
                                  context, '/register-home'),
                              style: FilledButton.styleFrom(
                                  backgroundColor: AppTheme.teal,
                                  foregroundColor: AppTheme.dark),
                              child: const Text('Go to Symposium →',
                                  style:
...
class _OrbitCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(color: Color(0x14132336), blurRadius: 20)
          ],
        ),
...
class _Journey extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: const BoxDecoration(
            border: Border(left: BorderSide(color: Color(0xFF30445C)))),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(number,
              style: const TextStyle(
                  color: AppTheme.teal, fontWeight: FontWeight.w900)),
          const SizedBox(height: 8),
          Text(title,
              style: const TextStyle(
                  color: Colors.white,
